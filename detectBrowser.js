function detectBrowser() {
  ...
  const browsers = [
    ...
    { name: 'Safari', check: () => ua.includes("Safari") && !ua.includes("Chrome") },
    ...
    { name: 'Puppeteer', check: () => navigator.webdriver === undefined && navigator.plugins.length === 0 && navigator.languages.length === 0 }, // Puppeteer has no plugins, languages are empty
